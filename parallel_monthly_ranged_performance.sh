...
for STATE_OF_CHARGE_MAXIMUM in $(seq $SOCMAX_BASH_MIN $SOCMAX_BASH_INC $SOCMAX_BASH_MAX); do
...
for EFFICIENCY_DISCHARGE in $(seq $ED_BASH_MIN $ED_BASH_INC $ED_BASH_MAX); do
for REST_BEFORE_CHARGE in $(seq $RBC_BASH_MIN $RBC_BASH_INC $RBC_BASH_MAX); do
for REST_AFTER_DISCHARGE in $(seq $RAD_BASH_MIN $RAD_BASH_INC $RAD_BASH_MAX); do
